...
public class LayoutTest extends BasicLoggerTest {
    ...
    public void testLogFormat() {
        ...
        LoggingEvent loggingEvent = new LoggingEvent(Logger.class.getName(), logger, org.kframe.rpc.logging.inner.Level.INFO,
